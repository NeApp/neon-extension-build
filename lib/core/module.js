...
function resolve(extension, path, type, name) {
  ...
  .then(function (module) {
    return Promise.resolve().then(function () {
      ...
      return _git.default.status(path, {
        debug: true
      }).catch(function () {
        return {
          ahead: 0,
      ...
      if ((0, _isNil.default)(repository.commit) && !repository.dirty) {
        Logger.error(_chalk.default.red("[".concat((0, _padEnd.default)(module.name, 40), "] Invalid repository status (no commit defined)")));
...
function resolveMany(path, extension) {
  ...
  return (0, _promise.runSequential)((0, _reduce.default)(extension.modules, function (modules, names, type) {
    ...
    var type = _ref.type,
        name = _ref.name;
    return resolve(extension, path, type, name);
