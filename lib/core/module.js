...
function getModulePath(basePath, name, type) {
  ...
  path = _path.default.join(basePath, (type.directory || '') + name);
...
function parseModuleManifest(extension, data) {
  ...
  manifest.permissions = (0, _uniq.default)(manifest.permissions);
  return manifest;
}
...
function resolve(extension, path, type, name) {
  ...
  return Promise.resolve(module).then(function (module) {
    return (0, _package.readPackageDetails)(module.path).then(function (pkg) {
      return _extends({}, module, (0, _omit.default)(pkg, ['repository']), {
        // Package
        package: pkg
      });
    });
  ...
  .then(function (module) {
    return Promise.resolve().then(function () {
      ...
      return _extends({}, module, (0, _pick.default)(repository, ['branch', 'commit', 'tag', 'latestTag']), {
        // Repository
  ...
  .then(function (module) {
    ...
    return _extends({}, module, (0, _pick.default)(extension.travis, ['branch', 'commit', 'tag']), {
      // Travis
