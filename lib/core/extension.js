...
function parseExtensionManifest(name, data) {
  return (0, _merge["default"])((0, _cloneDeep["default"])(BaseManifest), _objectSpread(_objectSpread({}, (0, _cloneDeep["default"])(data)), {}, {
    'modules': _objectSpread(_objectSpread({}, (0, _cloneDeep["default"])(data.modules)), {}, {
      'core': ['core', 'framework'],
      'packages': [name]
    })
  }));
...
function overlayExtensionManifest(extension, path) {
  return readExtensionManifest(extension, path, extension.channel).then(function (manifest) {
    ...
    return _objectSpread(_objectSpread({}, extension.manifest), manifest);
  });
}
...
function resolve(packageDir, browser) {
  ...
  .then(function (extension) {
    return (0, _package.readPackageDetails)(browser.path).then(function (pkg) {
      ...
      return _objectSpread(_objectSpread(_objectSpread({}, extension), pkg), {}, {
        // Package
        "package": pkg
      });
    });
  ...
  .then(function (extension) {
    return getExtensionManifest(extension, browser.path).then(function (manifest) {
      return _objectSpread(_objectSpread(_objectSpread({}, extension), (0, _omit["default"])(manifest, ['key'])), {}, {
        manifest: manifest
      });
    });
  ...
  .then(function (extension) {
    return Promise.resolve().then(function () {
      ...
      return _objectSpread(_objectSpread(_objectSpread({}, extension), (0, _pick["default"])(repository, ['branch', 'commit', 'tag', 'latestTag'])), {}, {
        // Repository
        repository: _objectSpread(_objectSpread({}, extension.repository || {}), repository)
      });
    });
  ...
  .then(function (extension) {
    return Promise.resolve().then(function () {
      ...
      return _objectSpread(_objectSpread(_objectSpread({}, extension), (0, _pick["default"])(travis, ['branch', 'commit', 'tag'])), {}, {
        // Travis
        travis: travis
      });
    });
  ...
  .then(function (extension) {
    return overlayExtensionManifest(extension, browser.path).then(function (manifest) {
      return _objectSpread(_objectSpread(_objectSpread({}, extension), (0, _omit["default"])(manifest, ['key', 'modules'])), {}, {
        // Manifest
        manifest: manifest
      });
    });
