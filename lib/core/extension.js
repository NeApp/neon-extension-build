...
function isDirty(_ref2) {
  ...
  for (var name in modules) {
    ...
    var module = modules[name]; // Check if module is dirty or ahead of latest tag
  ...
  .then(function (extension) {
    return Promise.resolve().then(function () {
      ...
      if ((0, _isNil.default)(repository.commit) && !repository.dirty) {
        Logger.error(_chalk.default.red("[".concat((0, _padEnd.default)(browser.package, 40), "] Invalid repository status (no commit defined)")));
