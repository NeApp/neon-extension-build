...
function resolve(packageDir, browser) {
  ...
  return Promise.resolve((0, _cloneDeep["default"])(browser)).then(function (browser) {
    return _objectSpread(_objectSpread({}, browser), findBrowser(packageDir, browser));
  }) // Resolve extension
  .then(function (browser) {
    return _extension["default"].resolve(packageDir, browser).then(function (extension) {
      return _objectSpread(_objectSpread({}, browser), {}, {
  ...
  .then(function (browser) {
    return _objectSpread(_objectSpread({}, browser), _version["default"].resolveBrowser(browser));
  });
}
