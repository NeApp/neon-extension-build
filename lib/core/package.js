...
function updatePackage(pkg) {
  ...
  function updateVersions(pkg, group) {
    ...
    return _objectSpread(_objectSpread({}, dependencies), (0, _mapValues["default"])((0, _pickBy["default"])(versions, function (_, name) {
...
function updatePackageLocks(locks) {
  ...
  return _objectSpread(_objectSpread({}, locks), {}, {
    // Update package version
    version: versions[locks.name] || locks.version,
    // Update dependencies
    dependencies: _objectSpread(_objectSpread({}, locks.dependencies), (0, _mapValues["default"])((0, _pickBy["default"])(locks.dependencies, function (_, name) {
      return name.indexOf('@radon-extension/') === 0;
