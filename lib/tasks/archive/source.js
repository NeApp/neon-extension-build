...
function getModuleVersions(browser) {
  return (0, _mapValues.default)(browser.modules, function (module) {
    ...
    return {
      version: "NeApp/".concat(module.name, "#").concat(module.repository.commit),
      from: "".concat(module.name, "@NeApp/").concat(module.name, "#").concat(module.repository.commit)
    };
  });
}
