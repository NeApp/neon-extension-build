...
function link(target, branch, module) {
  ...
  return clone(target, branch, module).then(function (_ref) {
    ...
    _vorpal.default.logger.info("[RadonApp/".concat(module, "#").concat(branch, "] Installing dependencies...")); // Install dependencies


    return _npm.default.install(localPath).then(_npm.default.createHandler(_vorpal.default.logger, "[RadonApp/".concat(module, "#").concat(branch, "]"))).then(function () {
      var linkPath = "".concat(target, "/node_modules/").concat(module);

      _vorpal.default.logger.info("[RadonApp/".concat(module, "#").concat(branch, "] \"").concat(linkPath, "\" -> \"").concat(localPath, "\"")); // Create link


      return _link.default.create(linkPath, localPath, ["".concat(target, "/.modules/"), "".concat(target, "/node_modules/")]);
    });
  }).catch(function (err) {
    _vorpal.default.logger.warn("[RadonApp/".concat(module, "#").concat(branch, "] Error raised: ").concat(err.message || err));
...
function linkModuleDependencies(target, branch, modules) {
  return (0, _promise.runSequential)(modules, function (module) {
    ...
    _vorpal.default.logger.info("[RadonApp/".concat(module, "#").concat(branch, "] Linking module dependencies...")); // Read "package.json" file
    ...
    return _fsExtra.default.readJson(_path.default.join(modulePath, 'package.json')).then(function (pkg) {
      ...
      return (0, _promise.runSequential)(Object.keys(pkg.peerDependencies), function (name) {
        ...
        _vorpal.default.logger.info("[RadonApp/".concat(module, "#").concat(branch, "] \"").concat(linkPath, "\" -> \"").concat(path, "\"")); // Create link to module
...
function pack(target, branch, name) {
  ...
  return clone(target, branch, name).then(function (_ref2) {
    ...
    _vorpal.default.logger.info("[RadonApp/".concat(name, "#").concat(branch, "] Installing dependencies...")); // Install dependencies


    return _npm.default.install(localPath).then(_npm.default.createHandler(_vorpal.default.logger, "[RadonApp/".concat(name, "#").concat(branch, "]"))).then(function () {
      _vorpal.default.logger.info("[RadonApp/".concat(name, "#").concat(branch, "] Packing module...")); // Pack module
      ...
      return _npm.default.pack(target, localPath).then(function (_ref3) {
        ...
        _npm.default.writeLines(_vorpal.default.logger, stderr, {
          defaultColour: 'cyan',
          prefix: "[RadonApp/".concat(name, "#").concat(branch, "]")
        });

        _vorpal.default.logger.info(_chalk.default.green("[RadonApp/".concat(name, "#").concat(branch, "] ").concat(file)));
    ...
    _vorpal.default.logger.warn("[RadonApp/".concat(name, "#").concat(branch, "] Error raised: ").concat(err.message || err));
