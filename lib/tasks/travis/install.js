...
function link(target, branch, name) {
  ...
  return clone(target, branch, name).then(function (_ref) {
    ...
    return _npm.default.install(localPath).then(_npm.default.createHandler(_vorpal.default.logger, "[NeApp/".concat(name, "#").concat(branch, "]"))).then(function () {
      ...
      return _link.default.create("".concat(target, "/node_modules/").concat(name), localPath, ["".concat(target, "/.modules/"), "".concat(target, "/node_modules/")]);
    });
  }).catch(function (err) {
...
function installModule(target, branch, modules) {
  ...
  return _npm.default.install(target).then(_npm.default.createHandler(_vorpal.default.logger)).then(function () {
    return (// Link required modules
      (0, _promise.runSequential)(modules, function (name) {
