...
function link(target, branch, module) {
  ...
  return clone(target, branch, module).then(function (_ref) {
    ...
    return _npm.default.install(modulePath).then(_npm.default.createHandler(_vorpal.default.logger, "[NeApp/".concat(module, "#").concat(branch, "]"))).then(function () {
      var linkPath = "".concat(target, "/node_modules/").concat(module);

      _vorpal.default.logger.info("[NeApp/".concat(module, "#").concat(branch, "] \"").concat(linkPath, "\" -> \"").concat(modulePath, "\"")); // Create link


      return _link.default.create(linkPath, modulePath, ["".concat(target, "/.modules/"), "".concat(target, "/node_modules/")]);
    });
  }).catch(function (err) {
