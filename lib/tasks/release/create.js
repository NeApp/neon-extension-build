...
function createReleases(log, browser, version, options) {
  ...
  return (0, _promise2.runSequential)(getModulesOrdered(browser), function (module) {
...
function updatePackageDependencies(versions, pkg, key) {
...
function updatePackages(log, browser, version, options) {
  ...
  return (0, _promise2.runSequential)(getModulesOrdered(browser), function (module) {
    ...
    updatePackageDependencies(versions, pkg, 'dependencies'); // Update development dependencies

    updatePackageDependencies(versions, pkg, 'devDependencies'); // Update peer dependencies

    updatePackageDependencies(versions, pkg, 'peerDependencies', true); // Read package metadata from file (to determine the current EOL character)
