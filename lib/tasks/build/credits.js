...
function mergeContributor(a, b) {
  return (0, _merge.default)(a, _objectSpread({}, b, {
...
function getPeople(modules) {
  ...
  for (var i = 0; i < modules.length; i++) {
    for (var key in modules[i]) {
      ...
      credits[key] = mergeContributor(_objectSpread({}, (0, _cloneDeep.default)(BaseAuthor), credits[key]), _objectSpread({}, (0, _cloneDeep.default)(BaseAuthor), (0, _pick.default)(modules[i][key], Object.keys(BaseAuthor))));
    }
  } // Sort credits
      ...
      for (var type in credits) {
        ...
        for (var i = 0; i < credits[type].length; i++) {
          ...
          if ((0, _isNil.default)(result[key])) {
            ...
            result[key] = _objectSpread({}, (0, _get.default)(result, [key], {}), person, {
...
var CreditsTask = _helpers.Task.create({
  ...
  _mkdirp.default.sync(basePath); // Build list of packages
