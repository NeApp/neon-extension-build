...
var _archive = _interopRequireDefault(require("../deploy/archive"));
...
var Build = _helpers.Task.create({
  ...
  required: [_assets.default, _credits.default, _extension.default, _manifest.default, _archive.default],
