...
function buildManifest(browser, environment, manifests) {
  ...
  for (var i = 0; i < manifests.length; i++) {
    ...
    current = _objectSpread(_objectSpread(_objectSpread({}, current), manifest), {}, {
      'icons': _objectSpread(_objectSpread({}, current.icons), manifest.icons),
...
function buildModuleManifest(browser, environment, module) {
  var manifest = _objectSpread(_objectSpread({
    'icons': {},
    'content_scripts': [],
    'web_accessible_resources': []
