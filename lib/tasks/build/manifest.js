...
function buildModulePermissions(browser, module) {
  ...
  var optionalPermissions = _toConsumableArray(module.manifest.optional_origins).concat(_toConsumableArray(module.manifest.optional_permissions)); // Destination / Source
...
var Manifest = _helpers.Task.create({
  ...
  required: ['clean', 'build:extension']
