...
function createConfiguration(browser, environment) {
  ...
  return {
    ...
    new _webpack.default.optimize.CommonsChunkPlugin({
      ...
      chunks: ['Background/Messaging', 'Background/Services/App', 'Background/Services/ContentScript', 'Background/Services/Library', 'Background/Services/Migrate', 'Background/Services/Scrobble'],
