...
function getBabelPaths(browser, environment) {
  ...
  (0, _forEach.default)((0, _sortBy.default)(modules, 'name'), function (module) {
    ...
    items.push.apply(items, _toConsumableArray(module.webpack.babel.map(function (path) {
      return (0, _path2.resolvePath)(_path.default.resolve(module.path, path), // Fallback to package modules
...
function createConfiguration(browser, environment) {
  ...
  return {
    ...
    new _webpack.default.optimize.CommonsChunkPlugin({
      ...
      chunks: ['background/main/main', 'background/migrate/migrate', 'background/messaging/messaging', 'background/messaging/services/contentScript', 'background/messaging/services/library', 'background/messaging/services/scrobble'],
      ...
      name: 'common',
      chunks: ['background/common', 'destination/common', 'source/common', 'application'],
      minChunks: function minChunks(module, count) {
        return shouldExtractModule(browser, environment, module, count, {
          chunk: 'common'
        });
