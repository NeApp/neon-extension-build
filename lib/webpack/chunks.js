...
function getModuleServices(browser, environment, module) {
  ...
  var framework = browser.modules['framework']; // Find module services
...
function createModule(browser, environment, module) {
  return _defineProperty({}, "Plugins/".concat(module.id, "/Main"), [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices([browser.modules['core']], _constants.Services.Configuration)), _toConsumableArray(getModuleServices(browser, environment, module))));
}
...
function createModuleChunks(browser, module) {
  ...
  (0, _forEach["default"])(module.webpack.modules || {}, function (_ref2, name) {
    ...
    result["Plugins/".concat(module.id, "/").concat(name)] = [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray((0, _map["default"])(modules, function (name) {
...
function createChunks(browser, environment) {
  ...
  return _objectSpread(_objectSpread({
    'Background/Messaging': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Messaging']),
    //
    // Services
    //
    'Background/Services/App': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/App']),
    'Background/Services/Callback': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/Callback']),
    'Background/Services/ContentScript': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/ContentScript']),
    'Background/Services/Library': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/Library']),
    'Background/Services/Migrate': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), _toConsumableArray(getServices(modules, _constants.Services.Migrate)), ['@radon-extension/core/Services/Migrate']),
    'Background/Services/Scrobble': [].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration)), _toConsumableArray(getServices(destinations, _constants.Services.Destination.Scrobble)), ['@radon-extension/core/Services/Scrobble']),
    //
    // Application
    //
    'Application': [// Ensure CSS Dependencies are bundled first
    '@radon-extension/core/App/App.Dependencies.scss'].concat(_toConsumableArray(browser.webpack.common), _toConsumableArray(getServices(modules, _constants.Services.Configuration, {
    ...
    return _objectSpread(_objectSpread({}, createModule(browser, environment, module)), createModuleChunks(browser, module));
  })))));
}