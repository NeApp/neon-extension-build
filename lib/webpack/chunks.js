...
function createChunks(browser, environment) {
  ...
  return _extends({
    ...
    'background/messaging/services/contentScript': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, 'configuration')), ['neon-extension-core/modules/background/messaging/services/contentScript']),
