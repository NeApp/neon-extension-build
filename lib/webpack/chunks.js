...
function createModule(browser, environment, module) {
  return _defineProperty({}, "Plugins/".concat(module.id, "/Main"), _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices([browser.modules['core']], _constants.Services.Configuration)), _toConsumableArray(getModuleServices(browser, environment, module))));
}
...
function createModuleChunks(browser, module) {
  ...
  (0, _forEach.default)(module.webpack.modules || {}, function (_ref2, name) {
    ...
    result["Plugins/".concat(module.id, "/").concat(name)] = _toConsumableArray(browser.webpack.common).concat(_toConsumableArray((0, _map.default)(modules, function (name) {
...
function createChunks(browser, environment) {
  ...
  return _objectSpread({
    'Background/Messaging': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Messaging']),
    //
    // Services
    //
    'Background/Services/App': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/App']),
    'Background/Services/Callback': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/Callback']),
    'Background/Services/ContentScript': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/ContentScript']),
    'Background/Services/Library': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), ['@radon-extension/core/Services/Library']),
    'Background/Services/Migrate': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), _toConsumableArray(getServices(modules, _constants.Services.Migrate)), ['@radon-extension/core/Services/Migrate']),
    'Background/Services/Scrobble': _toConsumableArray(browser.webpack.common).concat(_toConsumableArray(getServices(modules, _constants.Services.Configuration)), _toConsumableArray(getServices(destinations, _constants.Services.Destination.Scrobble)), ['@radon-extension/core/Services/Scrobble']),
    //
    // Application
    //
